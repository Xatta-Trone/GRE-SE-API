...
type PendingWordIndexRequestStruct struct {
...
func (c PendingWordIndexRequestStruct) Validate() error {
...
func PendingWordIndexRequest(c *gin.Context) (*PendingWordIndexRequestStruct, error) {
	var req PendingWordIndexRequestStruct
