...
func (c SavedListsIndexReqStruct) Validate() error {
...
func SavedListsIndexRequest(c *gin.Context) (*SavedListsIndexReqStruct, error) {
	var req SavedListsIndexReqStruct
